...
# length of m + n, where the first m elements denote the elements that should be merged, and the last n elements are set to 0 and should be ignored. nums2 has a length of n.
...
nums1 = [1,2,3,0,0,0] 
nums2 = [2,5,6]
final = result.merge(nums1, 3, nums2, 3)
print(final)
